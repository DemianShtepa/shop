...
Route::prefix("category")
    ...
    ->group(function () {
        ...
        Route::put("activate/{currentCategory}", "CategoryController@activate")->name("activate");
        Route::put("deactivate/{currentCategory}", "CategoryController@deactivate")->name("deactivate");
